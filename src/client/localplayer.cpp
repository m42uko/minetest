...
void LocalPlayer::applyControl(float dtime, Environment *env)
{
	...
	//std::cout << "dir@speed:" << control.movement_direction << " @ " << control.movement_speed << "\n"; //                                                          
...
//		(!control.up && !control.down); // TODO: Re-implement auto-jump for Joysticks                                                                                         

	bool could_autojump = false;
